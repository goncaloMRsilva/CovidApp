...
class TabelaDosagem(db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_DATA INTEGER NOT NULL, $CAMPO_DOSAGEM INTEGER NOT NULL, $CAMPO_ID_UTENTE LONG NOT NULL, $CAMPO_ID_VACINA LONG NOT NULL)")
    }
