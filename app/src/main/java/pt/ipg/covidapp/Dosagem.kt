...
data class Dosagem(var id: Long = -1, var DataAdministracao: Int, var Dose: Int, var IdUtente: Long, var IdVacina: Long, var IdProfSaude: Long)  {
    ...
    companion object {
        fun fromCursor(cursor: Cursor): Dosagem {
            ...
            return Dosagem(id, DataAdministracao, Dose, IdUtente, IdVacina, IdProfSaude)
        }
    }
}