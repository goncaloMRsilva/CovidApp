...
class AdapterDoses(val fragment: ListaDosesFragment) : RecyclerView.Adapter<AdapterDoses.ViewHolderDose>() {
    ...
    class ViewHolderDose(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        fun atualizaDose(dosagem: Dosagem) {
            this.dose = dosagem
        ...
        private fun seleciona() {
            ...
            DadosApp.dosesSelecionado = dose
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderDose {
        val itemDose = fragment.layoutInflater.inflate(R.layout.item_doses, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolderDose, position: Int) {
        ...
        holder.atualizaDose(Dosagem.fromCursor(cursor!!))
    }
